...
class Book:
    ...
    def __init__(self, digimedie):
        ...
        self.set_folder_path("." + os.path.sep + "books" + os.path.sep + str(self.media_id) + os.path.sep)
        self.get_manifest()
    ...
    def set_title(self):
        self.set_folder_path("." + os.path.sep + "books" + os.path.sep + self.title + os.path.sep)
